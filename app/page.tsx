      ...
      <section id="home" className="hero animate-fade-in" style={{ justifyContent: 'center' }}>
        <div className="hero-content" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
            <a href={siteConfig.github} target="_blank" rel="noopener noreferrer" className="btn" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            ...
            <a href={`mailto:${siteConfig.email}`} className="btn" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
